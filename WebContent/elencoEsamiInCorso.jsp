...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	...
	<head>
		...
		<title>Elenco Esami in corso</title>
	...
	<body>
		...
		<div align="center">
			<h2>Esami in corso</h2>
			<h4>Inserimento risultati Esame</h4>
		</div>
		<hr style="width: 50%; color:black; height: 1px; background-color:black;"/>
		<f:view>
			<h:form>
				<div align="center">
				<h:dataTable value="#{elencoEsamiInCorsoController.esamiSostenutiModel}" var="esamePaziente" styleClass="esamePazienteTable" headerClass="esamePazienteTableHeader" rowClasses="esamePazienteTableOddRow,esamePazienteTableEvenRow" border="1" width="50%">
   					<h:column> 
   					...
   					<h:column>
      					...
      					<div align="center">
							<h:commandButton value="Inserisci" action="#{elencoEsamiInCorsoController.inserimentoRisultati}" styleClass="btn btn-lg btn-success"/>
						</div>
   					</h:column>
   				</h:dataTable>
			</div>
